...
<script type="text/javascript">
	$(document).ready(function(){
		$.ajax({
			url:"${pageContext.request.contextPath}/goodstype/list",
			type:"GET",
			success:function(data){
				for(var i in data){
					var a = $("<a href='${pageContext.request.contextPath}/goods/listbytypeid?typeId="+data[i].id+"'>"+data[i].name+"</a>");
					$("#goodsType").append(a);
    	...
    	<div id="topdiv">
            ...
            <span style="float:right">
       			...
       			<c:if test="${not empty user}">
       				...
       				<li>|</li>
       				<a href="${pageContext.request.contextPath}/user/logout"  id="a_top">注销</a>
       				<li>|</li>
