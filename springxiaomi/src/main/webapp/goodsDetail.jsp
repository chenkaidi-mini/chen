...
<body>
	<%@ include file="header.jsp"%>
	   ...
	   <ol class="breadcrumb">
		  <li><a href="#">小米商城</a></li>
		  <li class="active"><a href="${pageContext.request.contextPath }/goods/listbytypeid?typeid=${goods.goodsType.id}">${goods.goodsType.name}</a></li>
	   </ol>
   </div>
		...
		<div class="row">
		  <div class="col-xs-6 col-md-6">
		    <a href="#" class="thumbnail">
		      <img src="${pageContext.request.contextPath}/image/${goods.picture}"  width="560" height="560"  alt="${goods.name}" />
		    </a>
		  </div>
		  <div class="col-xs-6 col-md-6">
