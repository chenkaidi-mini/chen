    ...
    <div class="panel-body">
        ...
        <div class="row ${pageBean.totalSize<=0?"div1":"" }">
            ...
            <c:forEach items="${pageBean.data}" var="g" varStatus="i">
                <div class="col-sm-3">
                    <div class="thumbnail">
                        <img src="${pageContext.request.contextPath}/image/${g.picture}" width="180" height="180"
                             alt="小米6"/>
                        <div class="caption">
                            <h4>商品名称<a href="${pageContext.request.contextPath}/goods/byid?id=${g.id}">${g.name}</a>
                            </h4>
                            <p>热销指数
        ...
        <c:if test="${pageBean.totalSize>0 }">
            <nav aria-label="..." class="text-center">
                <ul class="pagination">
                    ...
                    <c:if test="${pageBean.pageNum>1 }">
                        <li>
                            <a href="${pageContext.request.contextPath }/goods/listbytypeid?pageNum=${pageBean.pageNum-1}&pageSize=${pageBean.pageSize}&typeId=${typeId}"
                    ...
                    <c:forEach var="pn" begin="${pageBean.startPage }" end="${pageBean.endPage }" step="1">
                        ...
                        <c:if test="${pn!=pageBean.pageNum }">
                            <li>
                                <a href="${pageContext.request.contextPath }/goods/listbytypeid?pageNum=${pn }&pageSize=${pageBean.pageSize}&typeId=${typeId}">${pn }</a>
                            </li>
                        </c:if>
                    </c:forEach>
